...
public class WebdriverUtility {
	...
	public WebElement waitForElementClickable(WebElement element, int timeoutofsecond) {
		return new WebDriverWait(driver, Duration.ofSeconds(timeoutofsecond))
				.until(ExpectedConditions.elementToBeClickable(element));
	}

	public void waitAndClick(WebElement element) {
		waitForElementClickable(element, 10).click();
		;
	}
